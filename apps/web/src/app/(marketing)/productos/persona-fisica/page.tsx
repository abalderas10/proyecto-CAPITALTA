...
import { CheckCircle2, Home, UserCheck, FileEdit, Search, PenTool } from 'lucide-react'

export const metadata = {
  title: 'Préstamo con Garantía Inmobiliaria — Capitalta',
  description: 'Financiamiento para personas físicas respaldado por garantía.'
}

export default function Page() {
  const c = copyPersonaFisica
  const benefitIcons = [CheckCircle2, Home, UserCheck]
  const processIcons = [FileEdit, Search, PenTool]
