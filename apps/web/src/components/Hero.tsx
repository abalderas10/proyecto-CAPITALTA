...
export function Hero({ title, subtitle, primary, secondary, image }: { title: string; subtitle: string; primary?: { label: string; href: string }; secondary?: { label: string; href: string }; image?: string }) {
  return (
